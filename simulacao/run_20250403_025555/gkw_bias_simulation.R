...
configurations <- list(
  ...
  s_gkw = list(family = "gkw", params = list(alpha = 2, beta = 3, gamma = 0.8, delta = 3, lambda = 1.5)),
  ...
  s_bkw = list(family = "bkw", params = list(alpha = 2, beta = 3, gamma = 0.8, delta = 1.5)),
  ...
  s_kkw = list(family = "kkw", params = list(alpha = 2, beta = 3, delta = 3, lambda = 1.5)),
  ...
  s_ekw = list(family = "ekw", params = list(alpha = 2, beta = 3, lambda = 1.5)),
